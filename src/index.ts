...
const init = async () => {
  const client = await createAuth0Client({
    clientId: 'TmZeplBBP0eYlZvYHWEW1SEB2e5NhGvS', //cleintID from auth0
    domain: 'dev-4wju7t6wwxnbm0z4.us.auth0.com',//domain from auth0
    authorizationParams: {
      redirect_uri: 'https://the-catholic-herald-5d6c2-bedae55b34495.webflow.io/', //Redirect URL after login
    },
  });
